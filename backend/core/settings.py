...
# -------------------------------
SECRET_KEY = config('SECRET_KEY', cast=str, default='django-insecure-tuH7hhbsZ_sr1trF16f5NEQEQFaRmVglD0FhAIQ0Ab4-aj85aPffUxu9iT_QY5wyS-w')
...
DJOSER = {
    ...
    'SERIALIZERS': {
        ...
        'user_create_password_retype': 'apps.users.serializers.UserCreatePasswordRetypeSerializer',
